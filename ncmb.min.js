...
const hmacSHA256=require("crypto-js/hmac-sha256"),Base64=require("crypto-js/enc-base64"),fetch=require("node-fetch");class NcmbDS{constructor(e,t){this.applicationKey=e,this.clientKey=t,this.fqdn="mbaas.api.nifcloud.com",this.version="2013-09-01",this.signature=new Signature(this,e,t),this.applicationKeyName="X-NCMB-Application-Key",this.timestampName="X-NCMB-Timestamp"}Query(e){return new Query(this,e)}path(e){return`/${this.version}/classes/${e}/`}url(e){return`https://${this.fqdn}${this.path(e)}`}}class Signature{constructor(e,t,s){this.ncmb=e,this.applicationKey=t,this.clientKey=s,this.signatureMethodName="SignatureMethod",this.signatureMethodValue="HmacSHA256",this.signatureVersionName="SignatureVersion",this.signatureVersionValue="2"}create(e,t,s,i={}){const a=this.ncmb.path(s);i[this.signatureMethodName]=this.signatureMethodValue,i[this.signatureVersionName]=this.signatureVersionValue,i[this.ncmb.applicationKeyName]=this.applicationKey,i[this.ncmb.timestampName]=t;const n=Object.keys(i).sort().map(e=>`${e}=${encodeURI(i[e])}`).join("&"),c=[e,this.ncmb.fqdn,a,n].join("\n");return Base64.stringify(hmacSHA256(c,this.clientKey))}}class Query{constructor(e,t){this.ncmb=e,this.className=t,this.queries={}}async fetchAll(){const e=(new Date).toISOString(),t=this.ncmb.signature.create("GET",e,this.className,this.queries),s={};s[this.ncmb.applicationKeyName]=this.ncmb.applicationKey,s[this.ncmb.timestampName]=e,s["X-NCMB-Signature"]=t,s["Content-Type"]="application/json";const i=await fetch(this.ncmb.url(this.className,this.queries),{headers:s});return(await i.json()).results.map(e=>{const t=new NCMBObject(this.ncmb,this.className);return t.sets(e),t})}}class NCMBObject{constructor(e,t){this.ncmb=e,this.className=t,this.fields={}}sets(e){for(let t in e)["createDate","updateDate"].indexOf(t)>-1?this.fields[t]=new Date(e[t]):this.fields[t]=e[t]}get(e){return this.fields[e]}}const applicationKey="e617bee762e6c0799d20bc3ef45ead1ee87c99276c482a3c5b6b90e013d8a669",clientKey="65c3eb97f9fe9e90bba279611d405121ddc1ea9beaea92ea77ee7ceb02b91247",ncmb=new NcmbDS(applicationKey,clientKey);(async()=>{const e=ncmb.Query("Group"),t=await e.fetchAll();console.log(t)})();

},{"crypto-js/enc-base64":3,"crypto-js/hmac-sha256":4,"node-fetch":7}],2:[function(require,module,exports){
